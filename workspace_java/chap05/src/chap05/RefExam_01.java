...
public class RefExam_01 {
	...
	public static void main(String[] args) {
		...
		String name = "김민권";
		// = 오른쪽이 먼저 실행 됨
		// "김민권" 을 힙heap 영역에 할당하면 번지 획득
		// 스택stack 영역에 변수 name에 번지 저장
		...
		// "김" 따로 "민권" 따로 heap에 생기고
		// 더한 결화 따로 생김(그런데 String이라서 주소 재활용)
		
		String name5 = name;
		System.out.println("name5"+name5);
		name = "다른걸로";
		System.out.println("after name5: "+name5);//김민권
